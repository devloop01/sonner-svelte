...
<div class="headless">
	...
	<p class="headlessDescription">Today at 4:00pm - "{event}"</p>
	<button class="headlessClose" on:click={() => _toast.dismiss(toast.id)}>
...
<style>
	:global(ol[dir='ltr']) .headlessClose {
		--headless-close-start: unset;
		--headless-close-end: 6px;
	}

	:global(ol[dir='rtl']) .headlessClose {
